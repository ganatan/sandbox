...
```
target/backend-springboot-21-1.0.0.war
```
...
- http://localhost:8080/backend-springboot-21-1.0.0/
- http://localhost:8080/backend-springboot-21-1.0.0/persons
...
Accès local :
- http://localhost:8080/backend-springboot-21/
...
```bash
java -jar target/backend-springboot-21-1.0.0.jar
```
