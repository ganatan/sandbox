...
public class GroupPurchaseController {
  ...
  public GroupPurchase join(@PathVariable long id) {
    GroupPurchase groupPurchase = service.getItemById(id);
    ...
    if (!groupPurchase.joinableOk()) {
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Cannot join this GroupPurchase");
    }

    groupPurchase.getParticipants().add("Mick");
    return groupPurchase;
  }
}
